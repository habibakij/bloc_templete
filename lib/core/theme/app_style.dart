...
class AppTextStyles {
  ...
  /// ---------- Sub Title ----------
  static TextStyle subTitle({double fontSize = 18, FontWeight fontWeight = FontWeight.w600, Color? color, double letterSpacing = 0, double height = 1.2, TextDecoration? decoration, FontStyle fontStyle = FontStyle.normal}) {
    return TextStyle(
      fontSize: fontSize,
      fontWeight: fontWeight,
      color: color ?? AppColors.textColor,
